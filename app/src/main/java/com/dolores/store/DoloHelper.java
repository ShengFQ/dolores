...
public class DoloHelper {
    static final String TAG = "DoloHelper";
    private static DoloHelper instance;//单例
    private ExecutorService executor;//线程池服务
    private String username;//用户名
    private DoloModel doloModel = null;
    ...
    public synchronized static DoloHelper getInstance() {
        if (instance == null) {
            instance = new DoloHelper();
        }
        return instance;
    }
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setSettingsProvider(new EaseUI.EaseSettingsProvider() {
            ...
            public boolean isSpeakerOpened() {
                return doloModel.getSettingMsgSpeaker();
            }

            @Override
            public boolean isMsgVibrateAllowed(EMMessage message) {
                return doloModel.getSettingMsgVibrate();
            }

            @Override
            public boolean isMsgSoundAllowed(EMMessage message) {
                return doloModel.getSettingMsgSound();
            }

            @Override
            public boolean isMsgNotifyAllowed(EMMessage message) {
                if (message == null) {
                    return doloModel.getSettingMsgNotification();
                }
                if (!doloModel.getSettingMsgNotification()) {
                    return false;
                } else {
                    ...
                    if (message.getChatType() == EMMessage.ChatType.Chat) {
                        ...
                        notNotifyIds = doloModel.getDisabledIds();
                    } else {
                        chatUsename = message.getTo();
                        notNotifyIds = doloModel.getDisabledGroups();
                    }
    ...
    protected void setGlobalListeners(){
        ...
        isGroupsSyncedWithServer = doloModel.isGroupsSynced();
        isContactsSyncedWithServer = doloModel.isContactSynced();
        isBlackListSyncedWithServer = doloModel.isBacklistSynced();
        ...
        connectionListener = new EMConnectionListener() {
            ...
            public void onDisconnected(int error) {
                ...
                if (error == EMError.USER_REMOVED) {
                    ...
                    onUserException(Constants.ACCOUNT_KICKED_BY_CHANGE_PASSWORD);
                } else if (error == EMError.USER_KICKED_BY_OTHER_DEVICE) {
                    onUserException(Constants.ACCOUNT_KICKED_BY_OTHER_DEVICE);
                }
            }
        ...
        new Thread(){
            ...
            public void run(){
                try {
                    ...
                    doloModel.setGroupsSynced(true);
        ...
        new Thread(){
            ...
            public void run(){
                ...
                try {
                    ...
                    doloModel.setContactSynced(true);
        ...
        new Thread(){
            ...
            public void run(){
                try {
                    ...
                    doloModel.setBlacklistSynced(true);
    ...
    public Map<String, RobotUser> getRobotList() {
        if (isLoggedIn() && robotList == null) {
            robotList = doloModel.getRobotList();
        }
        return robotList;
    }
    /**
    ...
    public void setCurrentUserName(String username) {
        ...
        doloModel.setCurrentUserName(username);
    }
    /**
     * 获取用户id
     */
    public String getCurrentUsernName(){
        if(username == null){
            username = doloModel.getCurrentUsernName();
        }
        return username;
    }
    ...
    public Map<String, EaseUser> getContactList() {
        if (isLoggedIn() && contactList == null) {
            contactList = doloModel.getContactList();
        }
    ...
    public void updateContactList(List<EaseUser> contactInfoList) {
        ...
        doloModel.saveContactList(mList);
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
            ...
            broadcastManager.sendBroadcast(new Intent(Constants.ACTION_GROUP_CHANAGED));
        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = DoloHelper.getInstance().getContactList();
...
//                break;
        ...
        private void updateGroupNotificationStatus(String groupId, String groupName, String inviter, String reason,  
                                                   InviteMessage.InviteMessageStatus status) {
            InviteMessage msg = null;
            for (InviteMessage _msg : inviteMessgeDao.getMessagesList()) {
